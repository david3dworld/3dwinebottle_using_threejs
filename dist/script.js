...
const tick = () =>
{
  ...
  stats.begin()
    ...
    groupebouteille.rotation.y = 0.05 * elapsedTime
    groupebouteille.rotation.z = 0 * elapsedTime



    groupebouteille2.position.x = Math.cos( elapsedTime / 6 ) *1
    //groupebouteille2.position.y = (Math.sin( elapsedTime / 3 ) *0.4) 
    groupebouteille2.position.z = Math.sin( elapsedTime / 6 ) *1 

    groupebouteille2.rotation.x = 0* elapsedTime 
    groupebouteille2.rotation.y = 0.1* elapsedTime 
    groupebouteille2.rotation.z = (0* elapsedTime) +0.01
    ...
    groupegrain.position.z = Math.sin( elapsedTime / 3 ) *1.1
    ...
    groupegrain3.rotation.x = (0.9* elapsedTime) 
    groupegrain3.rotation.y = (0.9* elapsedTime ) 
    groupegrain3.rotation.z = (0.9* elapsedTime)
